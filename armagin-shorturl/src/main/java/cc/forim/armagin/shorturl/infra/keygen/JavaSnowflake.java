...
public class JavaSnowflake {
    ...
    public JavaSnowflake(long workerId, long dataCenterId) {
        ...
        this.epoch = LocalDateTime.of(2023, 1, 1, 0, 0, 0, 0).toEpochSecond(ZoneOffset.of("+8"));
    ...
    private void checkArgs(long workerId, long dataCenterId) {
        ...
        log.info("Worker starting.Epoch {},timestamp left shift {}, dataCenter id bits {}, worker id bits {}, " +
